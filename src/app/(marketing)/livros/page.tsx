    ...
    <section className="fm-site-page py-page">
      ...
      <header className="mb-10 max-w-3xl md:mb-14">
        ...
        <p className="text-paper-700 mt-6 text-base leading-relaxed md:text-lg">
          ...
          preparação para concursos, com ficha verificável em catálogo
          comercial — ISBN, editora e edição de cada título. O professor também
          assina capítulos em obras coletivas da área criminal.
        </p>
      </header>
          ...
          >
            ...
            <div className="flex flex-1 flex-col p-5 md:p-6">
              ...
              <a
                ...
                className="border-amber text-amber hover:bg-amber hover:text-carbon fm-mono mt-5 inline-flex items-center justify-center gap-2 border px-4 py-2.5 text-[11px] uppercase tracking-[0.16em] transition-colors"
              >
      ...
      <aside className="border-amber/30 bg-amber/5 mt-16 flex flex-wrap items-center justify-between gap-6 border-l-2 px-6 py-8 md:px-10">
        <div>
          ...
          <h2 className="text-paper mt-2 font-serif text-2xl leading-tight">
            Trajetória, formação e credenciais de {siteConfig.professor.fullName}.
          </h2>
        </div>
        <Link
          href="/sobre"
