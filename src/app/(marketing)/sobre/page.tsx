      ...
      <div className="fm-site-container">
        <header className="mb-10 lg:mb-16 lg:grid lg:grid-cols-[minmax(0,0.92fr)_minmax(0,1.08fr)] lg:items-center lg:gap-10 xl:gap-16">
          <div className="min-w-0">
            <p className="text-amber fm-mono mb-5 text-[10px] tracking-[0.32em] uppercase lg:mb-6">
              Sobre o professor
            </p>
            <h1
        ...
        <div className="grid items-start gap-10 lg:grid-cols-[minmax(300px,34%)_minmax(0,1fr)] lg:gap-10 xl:grid-cols-[minmax(340px,36%)_minmax(0,1fr)] xl:gap-14">
          <aside className="mx-auto flex min-h-0 w-full max-w-md flex-col gap-5 lg:sticky lg:top-28 lg:mx-0 lg:max-w-none">
            <figure className="m-0 shrink-0">
              <div className="border-amber/30 relative overflow-hidden border">
                ...
                <div
                  aria-hidden
                  className="from-carbon/40 absolute inset-0 bg-gradient-to-t via-transparent to-transparent"
                />
              </div>
            ...
            <div className="not-prose border-amber/25 from-paper/[0.02] flex flex-col gap-8 rounded-xl border bg-gradient-to-b to-transparent px-5 py-6 sm:px-6 sm:py-7">
              <div className="border-amber/30 space-y-5 border-l-2 pl-5">
                <p className="text-amber fm-mono text-xs font-medium tracking-[0.18em] uppercase sm:text-sm">
                  Em números
                </p>
              ...
              <blockquote className="border-amber/20 bg-paper/[0.04] rounded-lg border py-4 pr-4 pl-5">
                <p className="text-paper-800 font-serif text-base leading-relaxed italic sm:text-[17px] sm:leading-[1.65]">
                  {siteConfig.pvuShort}
                </p>
              </blockquote>
              ...
              >
                ...
                {sidebarLinks.map((item) => (
                  <a
                    ...
                    className="text-paper-800 hover:text-amber fm-mono text-sm font-medium tracking-[0.12em] uppercase transition-colors sm:text-[15px]"
                  >
                    {item.label} →
                  </a>
                ))}
          ...
          <div className="prose-juridica prose-juridica--fluid flex w-full min-w-0 flex-col gap-12">
            {/* — Credenciais (escaneável) — */}
            <section aria-labelledby="sobre-credenciais">
              <h2
                id="sobre-credenciais"
                className="text-paper fm-mono mb-6 text-[11px] tracking-[0.22em] uppercase"
              >
              ...
              <dl className="not-prose mt-6 grid gap-4 sm:grid-cols-2 sm:items-stretch lg:grid-cols-3">
                {credentialHighlights.map((item) => (
                  ...
                  >
                    <dt className="text-amber fm-mono shrink-0 text-[10px] tracking-[0.18em] uppercase">
                      {item.label}
                    </dt>
              ...
              <section
                ...
                className="not-prose border-paper-100 mt-10 border-t pt-10"
              >
                <div className="mb-6 flex flex-wrap items-end justify-between gap-4">
                  ...
                  <span className="text-paper-600 max-w-md text-sm leading-relaxed">
                    ...
                    Alumnus — fichas técnicas confirmadas em distribuidor
                    nacional.
                  </span>
                </div>
                    ...
                    >
                      ...
                      <div className="flex flex-1 flex-col p-5">
                        ...
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="text-amber fm-mono hover:text-paper mt-4 inline-flex items-center gap-1 text-[11px] tracking-[0.14em] uppercase transition-colors"
                        >
                          Ficha no catálogo →
                        </a>
                      </div>
            ...
            <section aria-labelledby="sobre-trajetoria">
              ...
              <p className="text-paper-600 mb-2 max-w-prose text-sm leading-relaxed">
                A sequência completa ({CAREER_JOURNEY_SPAN.from}–
                {CAREER_JOURNEY_SPAN.to}) está na jornada animada — no desktop,
                no painel ao lado; no celular,{" "}
                <a
                  href="#jornada-carreira"
            ...
            <section aria-labelledby="sobre-escola">
              ...
              <blockquote className="border-amber/40 not-prose border-l-2 py-1 pl-6">
                <p className="text-paper-800 font-serif text-xl leading-snug italic md:text-2xl md:leading-snug">
                  O conhecimento penal pelo ângulo da acusação não cabe em
                  cursos generalistas: aqui o currículo gira em torno da{" "}
                  <em className="text-amber not-italic">
                    prática forense real
                  </em>{" "}
                  e da{" "}
                  <em className="text-amber not-italic">jurisprudência viva</em>{" "}
                  do STJ e STF.
                </p>
              </blockquote>
