  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className="text-carbon absolute left-[5%] top-[74%] flex h-[34%] w-[42%] items-center justify-center font-mono text-[13px] font-bold tracking-[0.18em]"
          style={{
        ...
        >
          <span className="whitespace-nowrap">
            ACESSO <strong className="font-extrabold">RESTRITO</strong>
          </span>
        </div>
        <div
