...
export function TestimonialsSection({ variant = "home" }: Props) {
  ...
  return (
    <section
      className="relative z-10 px-[5%] py-16 lg:py-32"
      aria-labelledby="testimonials-title"
    >
      <div className="mx-auto max-w-[1200px]">
        <p className="text-amber mb-4 font-mono text-[10px] uppercase tracking-[0.2em]">
          {eyebrow}
        </p>
        <h2
          ...
          {items.map((t) => (
            ...
            >
              ...
              <footer className="border-paper-100 mt-6 border-t pt-4">
                ...
                <p className="text-paper-600 mt-1 font-mono text-[10px] uppercase tracking-[0.16em]">
                  {t.role}
                </p>
              </footer>
            </li>
