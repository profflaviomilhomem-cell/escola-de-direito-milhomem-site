...
import type { DosimetriaResult } from "@/lib/business/dosimetria";
...
export const CAUSAS_AUMENTO: Array<{
  slug: string;
  label: string;
  fracao: number;
}> = [
  {
    slug: "continuidade",
    label: "Continuidade delitiva (1/6 a 2/3)",
    fracao: 1 / 3,
  },
  {
    slug: "concurso-formal",
    label: "Concurso formal (1/6 a 1/2)",
    fracao: 1 / 6,
  },
  {
    slug: "qualificadora-aumento",
    label: "Causa especial — 1/3 (art. 226, II)",
    fracao: 1 / 3,
  },
  {
    slug: "violencia-domestica",
    label: "Violência doméstica (art. 61, II, f)",
    fracao: 1 / 2,
  },
];

export const CAUSAS_DIMINUICAO: Array<{
  slug: string;
  label: string;
  fracao: number;
}> = [
  {
    slug: "tentativa",
    label: "Tentativa (1/3 a 2/3) — art. 14, II",
    fracao: 2 / 3,
  },
  {
    slug: "arrependimento",
    label: "Arrependimento posterior — 1/3 a 2/3",
    fracao: 1 / 3,
  },
  {
    slug: "semi-imputavel",
    label: "Semi-imputabilidade — art. 26, p.ú.",
    fracao: 1 / 2,
  },
  {
    slug: "trafico-privilegiado",
    label: "Tráfico privilegiado — art. 33 §4°",
    fracao: 2 / 3,
  },
];
...
export function categoryOf(
  c: CrimePreset,
): "patrimonio" | "pessoa" | "drogas" | "outros" {
  ...
  "furto-simples": [
    {
      tribunal: "STJ",
      code: "Súmula 599",
      summary: "Insignificância afastada por reincidência específica.",
    },
    {
      tribunal: "STJ",
      code: "AgRg 1.892.401/RS",
      summary: "Furto noturno isolado: sem qualificadora se ausente violência.",
    },
    {
      tribunal: "STF",
      code: "HC 168.052/SP",
      summary: "Bem ínfimo + ausência de antecedentes = atipicidade material.",
    },
  ],
  "furto-qualificado": [
    {
      tribunal: "STJ",
      code: "HC 715.823/MG",
      summary: "Concurso de pessoas exige liame subjetivo demonstrado.",
    },
    {
      tribunal: "STJ",
      code: "Súmula 511",
      summary: "Privilégio aplica-se ao §4° quando primário e bem ínfimo.",
    },
  ],
  estelionato: [
    {
      tribunal: "STJ",
      code: "Súmula 17",
      summary: "Estelionato consumido pelo falso é absorvido.",
    },
    {
      tribunal: "STF",
      code: "HC 211.890/SP",
      summary: "Estelionato eletrônico: competência do local da vantagem.",
    },
  ],
  "roubo-simples": [
    {
      ...
      code: "Tese 56",
      summary:
        "Emprego de arma branca volta a qualificar (Lei 13.654/18 não retroage).",
    },
  ],
  "trafico-caput": [
    {
      tribunal: "STF",
      code: "RE 635.659",
      summary: "Distinção tráfico × usuário exige análise concreta.",
    },
    {
      tribunal: "STJ",
      code: "HC 769.842/SP",
      summary: "Apreensão fracionada + balança = mercancia.",
    },
  ],
};
