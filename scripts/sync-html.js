...
function parseChecklistMarkdown(content) {
...
function updateStaticHtmlFile(phases) {
  const dataItems = [];
...
<body>
  ...
  <div class="top-panel">
    ...
    <div class="controls-area">
      <button class="btn-action active" id="btn-view-tree" onclick="switchView('tree')">Mapa Mental</button>
      <button class="btn-action" id="btn-view-board" onclick="switchView('board')">Abas por Fase</button>
