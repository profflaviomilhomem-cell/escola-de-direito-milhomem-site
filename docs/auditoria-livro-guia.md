...
| PVU curta home: _“Direito Penal ensinado por quem está no MP”_ | Tagline suavizada em `copy.ts` (foco professor, MP só em `/sobre`) | ⚖️     |
| Tagline institucional footer: _“A Escola do Promotor.”_        | Footer usa nome “Flávio Milhomem”, sem tagline do guia             | 🟡     |
